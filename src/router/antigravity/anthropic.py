...
async def count_tokens(
    ...
    log.info(
        f"[ANTIGRAVITY-ANTHROPIC] /messages/count_tokens {ts('id_3264')}: client={client_host}:{client_port}, "
    ...
    try:
        ...
        log.error(f"[ANTIGRAVITY-ANTHROPIC] token {ts('id_3266')}: {e}")
...
if __name__ == "__main__":
    ...
    {ts(f"id_1635")}: python src/router/antigravity/anthropic.py
    """

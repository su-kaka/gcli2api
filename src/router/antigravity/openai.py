...
{ts(f"id_935")}Antigravity{ts('id_590')}OpenAI{ts('id_3197')}
"""
...
if __name__ == "__main__":
    ...
    {ts(f"id_1635")}: python src/router/antigravity/openai.py
    """
    ...
    def test_non_stream_request():
        f"""{ts('id_1646')}"""
        print("\n" + "=" * 80)
        print(f"{ts('id_14461')}{ts('id_1459')} (POST /antigravity/v1/chat/completions)")
        print("=" * 80)
    ...
    def test_stream_request():
        f"""{ts('id_1637')}"""
        print("\n" + "=" * 80)
        print(f"{ts('id_14462')}{ts('id_1445')} (POST /antigravity/v1/chat/completions)")
        print("=" * 80)
    ...
    def test_fake_stream_request():
        f"""{ts('id_3275')}"""
        print("\n" + "=" * 80)
        print(f"{ts('id_14463')}{ts('id_3276f')} (POST /antigravity/v1/chat/completions with {ts('id_121')} prefix)")
        print("=" * 80)

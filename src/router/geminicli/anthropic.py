...
async def count_tokens(
    ...
    log.info(
        ff"[GEMINICLI-ANTHROPIC] /messages/count_tokens {ts("id_3264")}: client={client_host}:{client_port}, "
    ...
    try:
        ...
        log.error(ff"[GEMINICLI-ANTHROPIC] token {ts("id_3266")}: {e}")
...
if __name__ == "__main__":
    ...
    {ts("id_1635")}: python src/router/geminicli/anthropic.py
    """
